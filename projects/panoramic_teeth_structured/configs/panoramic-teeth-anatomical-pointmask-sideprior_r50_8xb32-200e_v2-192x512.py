...
model = dict(
    ...
    head=dict(
        ...
        side_prior_mode='anatomy',
        contour_aux_weight=1.0,
        contour_attach_aux_weight=0.25,
        side_attach_weight=0.75,
        side_repel_weight=0.15,
...
train_pipeline = [
    ...
    dict(
        type='GenerateAnatomicalPointMaskTargets',
        line_width=2,
        use_side_contour_prior=True,
        num_contour_points=contour_points,
        point_encoder=codec),
    dict(type='PackAnatomicalPointMaskInputs')
]
...
val_evaluator = [
    ...
    dict(type='RootMaskMetric', threshold=0.5, prefix='structured'),
]
