...
STAGE1_CONFIG="projects/panoramic_teeth_structured/configs/panoramic-teeth-anatomical_dinov3-convnext-s_8xb32-200e_v2-192x512_stage1.py"
STAGE2_CONFIG="projects/panoramic_teeth_structured/configs/panoramic-teeth-anatomical_dinov3-convnext-s_8xb32-50e_v2-192x512_stage2.py"

STAGE1_WORK_DIR="${REPO_ROOT}/work_dirs/panoramic-teeth-anatomical_dinov3-convnext-s_stage1_400e_bs64_w8"
STAGE2_WORK_DIR="${REPO_ROOT}/work_dirs/panoramic-teeth-anatomical_dinov3-convnext-s_stage2_100e_bs32_w8"
