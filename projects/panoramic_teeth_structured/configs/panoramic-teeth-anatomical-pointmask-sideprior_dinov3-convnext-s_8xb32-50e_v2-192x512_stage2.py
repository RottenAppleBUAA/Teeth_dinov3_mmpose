...
_base_ = [
    './panoramic-teeth-anatomical-pointmask-sideprior_dinov3-convnext-s_8xb32-200e_v2-192x512_stage1.py'
]
...
stage1_work_dir = Path(
    './work_dirs/'
    'panoramic-teeth-anatomical-pointmask-sideprior_dinov3-convnext-s_8xb32-200e_'
    'v2-192x512_stage1'
)
work_dir = (
    './work_dirs/'
    'panoramic-teeth-anatomical-pointmask-sideprior_dinov3-convnext-s_8xb32-50e_'
    'v2-192x512_stage2'
)
